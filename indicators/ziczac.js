...
class ZicZacStream extends Duplex {
  constructor({ sensitivity = 2, highPropertyName = 'high', lowPropertyName = 'low', range, name = 'ziczac' } = {}) {
  ...
  addHigh(index) {
    ...
    this.buffer[index][this.name] = { type: 'high', change, period }
  ...
  addLow(index) {
    ...
    this.buffer[index][this.name] = { type: 'low', change, period }
